#ifndef CANNET_CONN_H
#define CANNET_CONN_H
...
namespace cannet {
    ...
    public:
        ...
        static TcpConnPtr
        createConnection(EventBase *base, const std::string &host, unsigned short port, int timeout = 0,
    ...
    public:
        ...
        void
        connect(EventBase *base, const std::string &host, unsigned short port, int timeout,
                const std::string &localip);
...
// Tcp服务器
    ...
    public:
        ...
        static TcpServerPtr
        startServer(EventBases *bases, const std::string &host, unsigned short port, bool reusePort = false);
